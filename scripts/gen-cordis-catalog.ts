...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  MemoryCaptureRequest: 'memory service request is owned by packages/experimental/memory/README.md',
  MemorySearchRequest: 'memory service request is owned by packages/experimental/memory/README.md',
  MemorySearchResult: 'memory service result is owned by packages/experimental/memory/README.md',
  ...
  ResolvedMemorySearchSpec: 'resolved memory request is owned by packages/experimental/memory/README.md',
  ...
  VerifierCompareRequest: 'verifier service request is owned by packages/experimental/verifier/README.md',
  VerifierCompareResult: 'verifier service result is owned by packages/experimental/verifier/README.md',
