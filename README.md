...
The detailed decision record is in [`docs/INTEGRATION_PLAN.md`](docs/INTEGRATION_PLAN.md). Every operational change is recorded in [`AUDIT_LOG.md`](AUDIT_LOG.md).
