...
- **Explicit search only** — TencentDB conversation capture, memory storage, automatic extraction, and prompt-time recall remain deferred. The `memory_search` consumer reads L1 atomic memories only.
